...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function generate_base_css() {
		...
		$css->set_selector( '.site .entry-hero-container-inner .hero-section-overlay' );
		...
		$css->set_selector( '.header-navigation .header-menu-container ul ul li' );
		...
		// Navigation.
		$css->set_selector( '.footer-navigation .footer-menu-container > ul > li > a' );
		...
		$css->set_selector( '.footer-navigation .footer-menu-container > ul li a:hover' );
		...
		$css->set_selector( '.footer-navigation .footer-menu-container > ul li.current-menu-item > a' );
		...
		if ( class_exists( 'woocommerce' ) ) {
			...
			$css->set_selector( 'body.archive.tax-product_cat, body.post-type-archive-product' );
			$css->render_background( kadence()->sub_option( 'product_archive_background', 'desktop' ), $css );
			$css->set_selector( 'body.archive.tax-product_cat .content-bg, body.content-style-unboxed.archive.tax-product_cat .site, body.post-type-archive-product .content-bg, body.content-style-unboxed.archive.post-type-archive-product .site, body.content-style-unboxed.archive.tax-product_cat .content-bg.loop-entry .content-bg:not(.loop-entry), body.content-style-unboxed.post-type-archive-product .content-bg.loop-entry .content-bg:not(.loop-entry)' );
